...
from backend.views import request_otp, verify_otp, create_account, login, password_reset_email, password_reset_form, \
    ...
    update_wishlist, update_cart, wishlist, cart, updateaddress, initiate_payment, notify_url, orders, orderdetails, \
    search, updateinfo, update_phone_request_otp, change_password, logout, viewall, notifications
